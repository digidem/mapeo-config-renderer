...
*/
function get(app) {
  app.get("/api/catfile/:catfile/presets/", async (req, res) => {
    try {
  ...
  app.get("/api/catfile/:catfile/preset/:presetName", async (req, res) => {
    try {
  ...
  app.get("/api/catfile/:catfile/fields", async (req, res) => {
    try {
      log("Getting fields");
      const catfile = await loadCatfile(req.params.catfile);
  ...
  app.get("/icons/catfile/:catfile/:iconName", async (req, res) => {
  ...
  app.get("/api/catfile/:catfile/metadata", async (req, res) => {
    try {
  ...
  app.get("/api/catfile/:catfile/categorySelection", async (req, res) => {
    const catfile = await loadCatfile(req.params.catfile);
